...
const translations = {
    pt: {
        ...
        about: {
            ...
            founderDesc: "Criação de soluções web e automações inteligentes para acelerar operações de negócio: sites e sistemas responsivos, integrações entre plataformas e agentes para atendimento automatizado. Do desenho da arquitetura ao deploy na Vercel, com foco em eficiência e escalabilidade.",
        ...
        agency: {
            ...
            card1Desc: "Plataforma de campanhas promocionais com autenticação JWT/bcrypt, cache em 5 camadas (↓40% no carregamento), integração com link de pagamento e emissão automática de notas fiscais via Nota Nacional. Dashboard admin com estatísticas em tempo real, em produção.",
        ...
        projects: {
            ...
            project1Description: "Sistema completo de campanhas promocionais online com Next.js 14, React e TypeScript. Implementei autenticação com JWT/bcrypt, cache em 5 camadas que reduziu o tempo de carregamento em 40%, dashboard administrativo com estatísticas em tempo real e design responsivo. Em produção com otimizações de performance e segurança.",
    ...
    en: {
        ...
        about: {
            ...
            founderDesc: "Built web solutions and smart automations to accelerate business operations: responsive websites and systems, cross-platform integrations, and automated support agents. End-to-end ownership from architecture to Vercel deployment, focused on efficiency and scalability.",
        ...
        agency: {
            ...
            card1Desc: "Promotional campaign platform with JWT/bcrypt auth, 5-layer cache (↓40% load time), payment link integration and automatic invoice issuance via Nota Nacional. Admin dashboard with real-time statistics, in production.",
...
const SKILL_DETAILS_PT = {
    ...
    'nextjs':          { name: 'Next.js',          level: 'Avançado · 2 anos',         tags: ['App Router', 'SSR/ISR', 'API Routes'],
        description: 'App Router, SSR/ISR, API Routes. Fortão Prêmios em produção com Next.js 14.' },
...
const SKILL_DETAILS_EN = {
    ...
    'nextjs':          { name: 'Next.js',          level: 'Advanced · 2 years',         tags: ['App Router', 'SSR/ISR', 'API Routes'],
        description: 'App Router, SSR/ISR, API Routes. Fortão Prêmios in production on Next.js 14.' },
